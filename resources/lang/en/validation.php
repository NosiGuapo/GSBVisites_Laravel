    ...
    */
    ...
    'custom' => [
        'login' => [
            ...
            'alpha_dash' => 'L\'identifiant ne peut contenir que caractères alpha-numériques et tirets.',
        ],
        'pass' => [
        ...
        'fname' => [
            'required' => 'Le prénom du médecin est obligatoire.',
            'max' => 'Le prénom spécifié contient plus de :max caractères.',
            'min' => 'Le prénom spécifié doit contenir au moins :min caractères.',
            'alpha_dash' => 'Le prénom ne peut contenir que caractères alpha-numériques et tirets.',
        ],
        'name' => [
            'required' => 'Le nom du médecin est obligatoire.',
            'max' => 'Le nom spécifié contient plus de :max caractères.',
            'min' => 'Le nom spécifié doit contenir au moins :min caractères.'
        ],
        'adress' => [
            'required' => 'L\'adresse du médecin est obligatoire.',
            'max' => 'L\'adresse spécifié est trop longue.',
            'min' => 'L\'adresse spécifié est trop courte.'
        ],
        'department' => [
            'max' => 'Le numéro de département est trop long.',
            'min' => 'Le numéro de département est trop court.',
            'integer' => 'Le département doit être un nombre'
        ],
        'phone' => [
        ...
        'spe' => [
            ...
            'max' => 'La spécialité indiquée contient plus de :max caractères.',
            'min' => 'La spécialité indiquée est trop courte.'
        ],
        'motive' => [
        ...
        'balance-sheet' => [
            ...
            'max' => 'Le bilan contient plus de :max caractères.',
